...
# 既存200問（data/gsm8k_subset.jsonl）から不良2問を除いた198問を保持し、
...
old_idx = [json.loads(l)["idx"] for l in open("data/gsm8k_subset.jsonl")]
...
with open("data/gsm8k_subset_regime.jsonl", "w") as f:
    for i in keep + new:
        q = ds[i]
